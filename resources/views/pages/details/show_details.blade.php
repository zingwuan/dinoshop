        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-6 g-4">
          <div class="col" style="margin-top:50px">
            <div class="card shadow-sm">
              <img src="{{('../frontend/images/sp1.jpg')}}" width="100%" height="490px"  alt="CHÂN VÁY XẾP LY" title="CHÂN VÁY XẾP LY">
          ...
          <div class="col" style="margin-top:50px">
            <div class="card shadow-sm">
              <img src="{{('../frontend/images/sp2.jpg')}}" width="100%" height="490px"  alt="QUẦN JEANS SKINNY" title="QUẦN JEANS SKINNY">
              <div class="icon-display-combo" >
                <img src="{{('../frontend/images/iconsale.png')}}" width="45px" alt="">
              </div>
              <div class="addCart">
          ...
          <div class="col" style="margin-top:50px">
            <div class="card shadow-sm">
              <img src="{{('../frontend/images/sp3.jpg')}}" width="100%" height="490px"  alt="">
              <div class="icon-display-combo" >
                <img src="{{('../frontend/images/iconsale.png')}}" width="45px" alt="">
              </div>
              <div class="addCart">
          ...
          <div class="col" style="margin-top:50px">
            <div class="card shadow-sm">
              <img src="{{('../frontend/images/sp4.jpg')}}" width="100%" height="490px"  alt="">
              <div class="icon-display-combo" >
                <img src="{{('../frontend/images/iconsale1.png')}}" width="45px" alt="">
              </div>
              <div class="addCart">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 0 16 16">
                  <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zM9 5.5V7h1.5a.5.5 0 0 1 0 1H9v1.5a.5.5 0 0 1-1 0V8H6.5a.5.5 0 0 1 0-1H8V5.5a.5.5 0 0 1 1 0z"/>
          ...
          <div class="col" style="margin-top:50px">
            <div class="card shadow-sm">
              <img src="../image/sp4.jpg" width="100%" height="490px"  alt="">
              <div class="icon-display-combo" >
