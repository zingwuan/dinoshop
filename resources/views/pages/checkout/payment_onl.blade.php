    ...
    <section id="cart_items">
		<div class="container">
			...
			<div class="review-payment">
				<h1 style="text-align: center">Cảm ơn bạn đã đặt hàng của chúng tôi!</h1>
			</div>
                </br>
            <form action="{{URL::to('/order-place')}}" method="POST">
                {{csrf_field()}}
			    <div class="payment-options">
				<input type="submit" value="Hoàn thành thanh toán" name="send_order_place" class="btn btn-primary">

					
					<span>
						<label><input name="payment_option" value="3" type="checkbox"> Hoàn thành thanh toán</label>
					</span>
